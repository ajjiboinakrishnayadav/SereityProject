...
public class Testbase {
  ...
  WebElement dateMonth= driver.findElement(By.xpath("//*[starts-with(@id,'owl-dt-picker-')]/div[2]/owl-date-time-calendar/div[1]/div/button/span"));
  Thread.sleep(3000);
 // WebElement backward=driver.findElement(By.xpath("//*[@id=\"owl-dt-picker-1\"]/div[2]/owl-date-time-calendar/div[1]/button[1]/span"));
  WebElement backward=driver.findElement(By.xpath("//button[@aria-label='Previous month']"));
  Thread.sleep(3000);

  //WebElement forward=driver.findElement(By.xpath("//*[@id=\"owl-dt-picker-1\"]/div[2]/owl-date-time-calendar/div[1]/button[2]/span"));
  ...
  try {
	...
	driver.findElement(By.xpath("//owl-date-time-month-view/table/tbody/tr/td/child::span[text()='"+day+"']")).click();
			//	
